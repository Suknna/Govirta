...
Govirta keeps planning details out of the README. Use `docs/superpowers/specs/` for design notes and `docs/superpowers/plans/` for execution plans.

The virtualization stack is permanently QEMU + QMP + qemu-img + netlink. **Govirta will not integrate libvirt.**
